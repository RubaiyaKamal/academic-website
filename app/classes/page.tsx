  ...
  return (
    ...
    <Header/>
     <div className="cont h-[150vh] w-screen flex flex-wrap relative mt-9 left-0">
        ...
        <div className="cont2 pt-1 -ml-6 mb-12 -mt-48  flex flex-col relative w-[75vh] h-[38vh] justify-start items-center mx-auto  bg-cyan-300">
        ...
        <div className="cont4 pt-1 -ml-6 mb-12 -mt-48 flex flex-col relative w-[75vh] h-[38vh] justify-start items-center mx-auto  bg-cyan-300">
        ...
        <div className="cont5 pt-1 mb-4 -mt-48 flex flex-col relative w-[75vh] h-[38vh] justify-start items-center mx-auto  bg-cyan-300">
        ...
        <div className="cont6 pt-1 -ml-6 mb-4 -mt-48 flex flex-col relative w-[75vh] h-[38vh] justify-start items-center mx-auto  bg-cyan-300">
