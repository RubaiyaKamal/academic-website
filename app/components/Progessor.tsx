...
return (
 ...
 {/*School name Main Page */}
     <div className="main flex flex-col relative bg-cyan-500 h-[94vh] w-screen">
      ...
      <br/>
      <h1 className="sub-text-1 flex ml-24 mt-20 w-[90vh] text-7xl text-white font-mono font-extrabold">New Approach to Kids Education</h1>
      <br/>
      <p className="detail flex ml-24 mb-8 w-[90vh] mt-2 justify-center items-center m-auto text-white text-xl">
  ...
  <div className="flex flex-row justify-end items-end m-auto ml-56 pb-16 mt-16 w-[150vh] h-[15vh]">
