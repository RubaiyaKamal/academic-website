  ...
  return (
    ...
    <Header/>
     <div className="cont h-[150vh] w-screen flex flex-wrap relative mt-9 left-0">
        ...
        <div className="cont1 mb-4 -mt-48 flex flex-col relative w-[75vh] h-[36vh] justify-start items-center mx-auto  bg-cyan-300">
        ...
        <div className="cont2 -ml-6 -mt-48 flex flex-col relative w-[75vh] h-[36vh] justify-start items-center mx-auto  bg-cyan-300">
        ...
        <div className="cont3 mb-4 -mt-48 flex flex-col relative w-[75vh] h-[36vh] justify-start items-center mx-auto  bg-cyan-300">
        ...
        <div className="cont4 -ml-6 -mt-48 flex flex-col relative w-[75vh] h-[36vh] justify-start items-center mx-auto  bg-cyan-300">
        ...
        <div className="cont5 mb-4 -mt-48 flex flex-col relative w-[75vh] h-[36vh] justify-start items-center mx-auto  bg-cyan-300">
        ...
        <div className="cont6 -ml-6 -mt-48 flex flex-col relative w-[75vh] h-[36vh] justify-start items-center mx-auto  bg-cyan-300">
